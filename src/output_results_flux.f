...
!***********************************************************************
     ...
     2     conc_string, nfavgzones, water_flux
...
c****************Begin executable statements here ******************
     ...
     &                    water_flux(touched_cells(i))
                  ...
                  do i = 1, n_touched_cells
                     write(output_unit_number, 110) touched_cells(i),
     &                    cfavg(touched_cells(i)), 
     &                    water_flux(touched_cells(i))
                  end do
               end if
...
!               if (first) write(output_unit_number, *) n_touched_cells
 ...
 90      format ('variables= "x", "y", "z", "node", ',
     &        '"concentration (moles/l)" "water flux (l/s)"')
 ...
 100        format (1x, 3(g16.9, 1x), i7, 1x, g16.9, 1x, g16.9)
 105        format ('zone t="time ',g16.9,'", VARSHARELIST = ([1-3]=1)')
 110        format (i7, 1x, g16.9, 1x, g16.9)
